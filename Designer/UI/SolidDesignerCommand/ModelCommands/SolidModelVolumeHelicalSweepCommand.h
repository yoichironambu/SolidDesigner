...
namespace sdr
{
	class SolidModelVolumeHelicalSweepCommand final : public AppCommandBase
	{
	public:
		SolidModelVolumeHelicalSweepCommand() noexcept;

		~SolidModelVolumeHelicalSweepCommand() override ;
